    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-start gap-7">
        <div className="flex items-start justify-start gap-2">
          ...
          <div>
            <p className="font-semibold leading-tight text-md">Thu 22 Feb 2024 at 10:00</p>
        ...
        <div className="flex items-start justify-start gap-2">
          ...
          <div>
            <p className="font-semibold leading-tight text-md">Spa Life & Massage</p>
            <p className="text-sm text-neutral-500">Street 420, Addington, London, EH1 1AE, UK</p>
          </div>
        </div>
        <div className="flex items-start justify-start gap-2">
          <AiOutlineUser className="text-2xl" />
          <div>
            <p className="font-semibold leading-tight text-md">Nelson Mandela</p>
      ...
      <div className="flex items-start justify-start gap-4 pt-3">
        <div className="space-y-3">
          ...
          <Button variant="outline" className="p-[1px] text-neutral-700 uppercase bg-gradient-to-r from-[#FF0000] via-red-400 to-[#0AADA4]" parent>
            <Link href={'/'} className="flex items-center flex-1 w-full h-full gap-2 px-3 bg-white rounded-full hover:bg-primary"><TbLocation /> Get direction</Link>
          </Button>
        </div>
        <div className="space-y-3">
