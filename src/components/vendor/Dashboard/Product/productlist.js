...
function ProductList() {
    ...
    const [products, setProducts, getProducts] = useProductList({
    ...
    const deleteProduct = async id => {
        ...
        if (resp && resp.code === 200) {
            ...
            setProducts({
                ...products,
                data: { ...products.data, products: newData },
            });
        }
    };
    ...
    return (
        <>
            <div className="flex items-center justify-between">
                <p className="text-lg font-semibold md:text-2xl">Products</p>
                    ...
                    products?.data?.products?.length > 0 && (
                        <>
                            ...
                            <Pagination className={'py-3 relative'}>
                                <PaginationContent
                                    className={products?.loading && 'opacity-0'}
                                >
