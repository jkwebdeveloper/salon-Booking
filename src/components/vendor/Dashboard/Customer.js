  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Dialog open={addCustomer}>
            ...
            <DialogContent close={setAddCustomer} className="sm:max-w-[550px]">
      ...
      <div className="overflow-x-auto bg-white rounded-lg">
        {(loading && <PageLoader />) ||
          (customers?.length == 0 && (
            <p className="px-2 py-10 text-center">No customers found</p>
          )) || (
                ...
                <tr>
                  <th
                    ...
                    onClick={(e) => {
                      ...
                      e.target.closest("th").querySelector("input").checked =
                        !checked;
