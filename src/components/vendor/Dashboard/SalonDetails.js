...
const SalonDetails = () => {
    ...
    const getVendor = useCallback(async () => {
        const resp = await POST.request({
            url: '/vendor/vendor-details-by-id',
    ...
    return (
        <form
            className="relative w-full space-y-12 bg-white rounded-xl"
            noValidate
                ...
                <div className="grid items-center justify-center grid-cols-2 md:grid-cols-4 lg:grid-cols-8">
                        ...
                        vendorPhotos.map(photo => (
                            ...
                            >
                                <div className="relative rounded-lg p-1 w-[6.5rem] h-[6.5rem] mb-2">
                                    ...
                                    <Button
                                        variant="primary"
                                        className="absolute top-0 right-0 w-10 h-6 p-2 bg-red-500"
                                        onClick={e =>
                                            setVendorPhotos(
                                                vendorPhotos.filter(
                            ...
                            >
                                <div className="relative rounded-lg p-1 w-[6.5rem] h-[6.5rem] mb-2">
                                    ...
                                    <Button
                                        variant="primary"
                                        className="absolute top-0 right-0 w-10 h-6 p-2 bg-red-500"
                                        onClick={e => deletePhoto(photo.id)}
                    ...
                    <div className="relative flex items-center justify-center top-10 group/photos">
                        <div className="relative rounded-lg bg-white ring-1 flex items-center justify-center p-1 w-[6.5rem] h-[6.5rem] mb-2">
                            ...
                            />
                            <Button variant="primary" className="w-10 h-6 p-2">
                                +
                            </Button>
                        </div>
                    </div>
