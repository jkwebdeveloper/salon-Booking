  ...
  return (
    <>
      <div className="flex items-center gap-6">
        <p
          className={`cursor-pointer ${active === "supplierInfo"
        ...
        <p
          className={`cursor-pointer ${active === "assignedProducts"
              ? "text-[#0AADA4] font-semibold"
              : "text-[#808080] font-normal"
            }`}
...
export default SupplierNewEditModal;
