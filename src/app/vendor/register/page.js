...
const Register = () => {
    ...
    const RegisterVendor = async e => {
        ...
        setLoading(true);
        const oldData =
            (localStorage.getItem('new_vendor') &&
                JSON.parse(localStorage.getItem('new_vendor'))) ||
            null;
    ...
    const updateHours = async e => {
        ...
        Object.keys(selectedDays).map(day => {
            (!selectedDays[day]?.from_time || !selectedDays[day]?.to_time) &&
                isValid.push(day);
        });
        if (isValid.length == 0) {
            const oldData =
    ...
    return (
        <div>
            ...
            <div className="container relative p-3 space-y-4 bg-white shadow-lg xl:p-8 ring-1 ring-primary/5  max-w-[800px] mx-auto  md:mt-[-3rem] mt-3 md:mb-10 z-[2]">
                        ...
                        >
                            ...
                            <div className="flex items-center">
                                <input
                                    ...
                                    onChange={e =>
                                        setFormData({
                                            ...formData,
                                            is_agree_terms: e.target.checked
                                                ? 1
                                                : 0,
                                        })
                                    }
                                    defaultChecked={
                                        (formData?.is_agree_terms == 1 &&
                                            true) ||
                                        false
                                    }
                            ...
                            <div className="flex items-center">
                                ...
                                >
                                    ...
                                    receive communications to grow your business
                                    with expert advice, industry insights, and
                                    other handy resources – delivered right to
                                    your inbox.
                                </label>
                            </div>
                            <input
