...
const TaxStrategy = async () => {
  const resp = await GET.request({ url: "/tax-strategy" });
  const textStrategyData = (resp && resp.code === 200) && resp.data || [];
  return (
...
export default React.memo(TaxStrategy);
